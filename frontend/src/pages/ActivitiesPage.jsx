...
export default function ActivitiesPage() {
  ...
  const openWhatsApp = (experienceName) => {
    const message = `Ciao, vorrei informazioni su: ${experienceName}`;
          ...
          <div className="horizontal-scroll">
            {topExperiences.map((exp) => (
              <Card 
                ...
                data-testid={`experience-top-${exp.id}`}
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between mt-3">
                    ...
                    <Button
                      size="sm"
                      onClick={() => openWhatsApp(exp.name)}
                      className="whatsapp-btn text-white rounded-xl text-xs"
                    >
                      <MessageCircle className="w-3 h-3 mr-1" /> Info
                    </Button>
                  </div>
                </div>
              </Card>
                ...
                <div className="flex-1 p-4">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <Button
                      ...
                      data-testid={`experience-contact-${exp.id}`}
                    >
                      <MessageCircle className="w-3 h-3 mr-1" /> Chiedi info
                    </Button>
                  </div>
                </div>
              </Card>
      ...
      >
        <Card className="p-5 rounded-2xl bg-slate-900 text-white">
          ...
          <p className="text-slate-400 text-sm mb-4">
            Scrivici e ti aiuteremo a organizzare l'esperienza perfetta.
          </p>
          <Button
            onClick={() => openWhatsApp("Ciao, vorrei un consiglio su cosa fare oggi")}
